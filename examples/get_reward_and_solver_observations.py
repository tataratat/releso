...
if __name__ == "__main__":
    ...
    if args.reset or not local_variable_store_path.exists():
        ...
        if args.validation_value is not None:
            local_variable_store["goal"] = args.validation_value
        ...
        reward_solver_logger.info(f"Resetting with new goal: {local_variable_store['goal']}; The goal is set from the outside: {args.validation_value}")
